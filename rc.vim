...
" Load Plugins
if  $VUNDLE == "true"
    "runtime! $BASE_PATH/vim/bundle/vundle.vim
    execute  "source $BASE_PATH/bundle/vundle.vim"
else
    execute  "source $BASE_PATH/bundle/static.vim"

    autocmd FileType cpp source $VIMRT/lang/cpp.vim
    autocmd FileType java source $VIMRT/lang/java.vim
    autocmd FileType perl source $VIMRT/lang/perl.vim
    autocmd FileType php source $VIMRT/lang/php.vim
...
"map <leader>1 :imapc <buffer><cr>:source $BASE_PATH/vim/vimrc<cr>:set syntax=java<cr>
